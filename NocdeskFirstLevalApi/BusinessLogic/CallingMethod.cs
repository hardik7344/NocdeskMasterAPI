...
namespace NocdeskFirstLevalApi.BusinessLogic
{
    public class CallingMethod
    {
        ...
        //internal static Task<string> post_method_data(string baseUrl, ParameterJSON common)
        //{
        ...
        [HttpPost]
        public static string post_method2(string baseUrl, ContractMaster common)
        {
            string result = "";
            try
            {
        ...
        [HttpPost]
        //public static string PutMethod(string baseUrl, UserActivity useract)
        //{
        //    string result = "";
        //    HttpResponseMessage httpResponse = new HttpResponseMessage();
        //    using (var httpClientHandler = new HttpClientHandler())
        ...
        //        using (var httpClient = new HttpClient(httpClientHandler))
        //        {
        //            httpResponse = await httpClient.PutAsJsonAsync(baseUrl, useract);
        //            if (httpResponse.IsSuccessStatusCode)
        //            {
        //                result = httpResponse.Content.ReadAsStringAsync().Result;
        //            }
        ...
        //[HttpGet]
        //public static async Task<string> get_method5(string baseUrl)
        //{
        //    string result = "";
        //    HttpResponseMessage httpResponse = new HttpResponseMessage();
